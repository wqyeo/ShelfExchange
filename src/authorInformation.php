...
include "php_util/authorInformationFetcher.php";
$authorId = $_GET['author'];
$authorInformationFetcher = new AuthorInformationFetcher($authorId, $connection);
?>
...
echo '<script>displayTagInformation(' . json_encode($authorInformationFetcher->getAuthorInformation())  . ');</script>'
?>
  <section class="py-5">
    <div class="container px-4 px-lg-5 mt-3">
      <div class="row">
        <div class="col text-center mb-4">
          <h2>Books with the Author</h2>
          <hr class="mx-auto">
        </div>
      </div>
  ...
  $authorInformationFetcher->displayBooksWithAuthor();
